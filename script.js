...
function updateContent(section) {
 ...
 case 'Devices':
            htmlContent = `
                ...
                <ul>
                    <li>
                        <img class="device-image" id="front-door-image" src="https://i.imgur.com/gl342Zl.jpg" alt="Front Door" onclick="triggerFileInput('front-door-image')">
                        <span class="status-indicator locked" id="front-door-status"></span>
                        <span contenteditable="true" class="editable">Front Door</span>
                    </li>
                    <li>
                        <img class="device-image" id="back-door-image" src="https://i.imgur.com/XRGQpiH.jpeg" alt="Back Door" onclick="triggerFileInput('back-door-image')">
                        <span class="status-indicator unlocked" id="back-door-status"></span>
                        <span contenteditable="true" class="editable">Back Door</span>
                    </li>
                    <li>
                        <img class="device-image" id="window-image" src="https://i.imgur.com/b4pazIG.jpg" alt="Window" onclick="triggerFileInput('window-image')">
                        <span class="status-indicator locked" id="window-status"></span>
                        <span contenteditable="true" class="editable">Window</span>
                    </li>
                </ul>`;
            break;
    ...
    case 'Settings':
        htmlContent = `
            ...
            <div class="settings-container">
                ...
                <div class="setting">
                    <label>Notifications: <input type="checkbox" id="notificationsToggle"></label>
                </div>
                <div class="setting">
                    <label>Language: 
                ...
                <div class="setting">
                    <label>Location Sharing: <input type="checkbox" id="locationToggle"></label>
                </div>
                <div class="setting">
                    <label>Sound Effects: <input type="checkbox" id="soundEffectsToggle"></label>
                </div>
...
function logOff() {
    ...
    // Hide the app content and show the login form
    document.getElementById('appContent').style.display = 'none';
    ...
    // Optional: Reset the login form fields
